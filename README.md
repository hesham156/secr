...
- Do not set `NODE_ENV` to custom values on Railway or any host. Leave it unset or set it exactly to `production`; values like `Production`, `prod`, or `staging` can break Next.js and React build/runtime assumptions.
